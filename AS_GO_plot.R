...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/SE_GO.pdf",height = 10,width = 15)
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/A3SS_GO.pdf",height = 10,width = 15)
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/A5SS_GO.pdf",height = 10,width = 15)
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/AFE_GO.pdf",height = 10,width = 15)
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/ALE_GO.pdf", height = 10,width = 15)
...
library(pheatmap)
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/AS_GO_Count_Heatmap.pdf")
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/AS_GO_Count_circular.pdf")
circos.par(start.degree = 270, gap.after = c(rep(2, nrow(mat)-1), 10, rep(0, ncol(mat)-1), 10))# 块儿与块儿之间的空格
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/AS_GO_circos.pdf")
circos.par(start.degree = 270, gap.after = c(rep(2, nrow(mat)-1), 10, rep(0, ncol(mat)-1), 10))# 块儿与块儿之间的空格
chordDiagram(mat_sort, annotationTrack = "grid", transparency = 0.5, 
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/AS_GO_p.adjust_Heatmap.pdf")
...
ALE_L3 <- ALE[ALE$ID %in% ALE_DAG$level2nodes$`3`,]
...
pdf("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/AS_GO_Count_circos_at_levels3.pdf")
...
pushViewport(viewport(x = unit(90, "mm"), y = unit(20, "mm"), 
...
sum(SE$ID %in% GOBPOFFSPRING[["GO:0032259"]])
SE[SE$ID %in% GOBPOFFSPRING[["GO:0006457"]],]
AFE[AFE$ID %in% GOBPOFFSPRING[["GO:0006457"]],]
...
DAVID_SE <- read.table("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/DAVID_SE.txt", sep = "\t", header = T, stringsAsFactors = F)
DAVID_SE <- DAVID_SE[DAVID_SE$FDR<0.05,]
DAVID_A3SS <- read.table("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/DAVID_A3SS.txt", sep = "\t", header = T, stringsAsFactors = F)
DAVID_A3SS <- DAVID_A3SS[DAVID_A3SS$FDR<0.05,]
DAVID_A5SS <- read.table("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/DAVID_A5SS.txt", sep = "\t", header = T, stringsAsFactors = F)
DAVID_A5SS <- DAVID_A5SS[DAVID_A5SS$FDR<0.05,]
DAVID_AFE <- read.table("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/DAVID_AFE.txt", sep = "\t", header = T, stringsAsFactors = F)
DAVID_AFE <- DAVID_AFE[DAVID_AFE$FDR<0.05,]
DAVID_ALE <- read.table("/Users/tangchao/CloudStation/tangchao/project/UCB/AS_GO/more than one cell/DAVID_ALE.txt", sep = "\t", header = T, stringsAsFactors = F)
DAVID_ALE <- DAVID_ALE[DAVID_ALE$FDR<0.05,]
